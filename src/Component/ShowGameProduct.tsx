...
export default function ShowGameProduct() {
  ...
  return (
    <div className="container  mx-auto p-4">
      <h1 className="text-3xl text-center shadow-md p-4 rounded-lg bg-white font-semibold mb-8 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        {gamedata.map((items, ind) => (
          <div
            key={ind}
            className="flex flex-col items-center justify-center p-8 shadow-2xl border border-gray-200 bg-white rounded-lg w-11/12"
          >
            <img
              src={items.prod_img}
              alt="prod_img"
            ...
            <p className="text-gray-500">ราคา {items.prod_price} บาท</p>
            <button
